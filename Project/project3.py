...
rating = st.sidebar.text_input('Ratings')
duration = st.sidebar.text_input('Duration [in hours]')
...
with open('/Users/manikantachundurubalaji/Downloads/USC/DataScience/DSCI560/Project/LDA BOW latest/index_lda_bow.pkl', 'rb') as file2:
...
# lda_vector_bow_test = lda_model[bow_vector]
# print(lda_vector_bow_test)
lda_model_final = models.LdaModel.load('/Users/manikantachundurubalaji/Downloads/USC/DataScience/DSCI560/Project/LDA BOW latest/ldamodels_bow_45.lda')
...
print("result_df['rating']",result_df['rating'])
print("result_df['duration']",result_df['duration'])

def cleanratings(row):
    temp=row.split("\n")
    return temp[0]

result_df['rating']=result_df['rating'].apply(cleanratings)
print("result_df['rating']",result_df['rating'])
...
if duration:
  result_df = result_df[result_df['duration'] <= int(duration)]
# if levels:
...
top12offeredby=list(top12['offered_by'])
top12duration=list(top12['duration'])
top12ratings=list(top12['rating'])
top12ratings=[x.replace("\n"," ") for x in top12ratings]

print('top12courses',top12courses)
print('top12offeredby',top12offeredby)
print('top12duration',top12duration)
print('top12ratings',top12ratings)
# result=result_df['course_title']
# ratings=list(result_df['rating'])
# ratings=[x.replace("\n"," ") for x in ratings]
# duration=list(result_df['duration'])
...
#     st.session_state['df']=reco_course_list['course_name'][:12]
...
if unseen_document:
    if len(result)>0:
        ...
        st.write("No Courses found for the particular selection")
        st.write("Top 12 Most Popular Courses")
        col1, col2, col3 = st.columns(3)
        ...
        with col1:
            ...
            url = "http://localhost:8501/coursepage"
            case = 0
            st.text("By : " + top12offeredby[0])
            st.text("Ratings : " + top12ratings[0])
            st.text("Duration : " + str(str(top12duration[0]) + " hr"))
            # login = st.button("coursepage",key="key0")
            #
            # if login:
            #     print("inside login")
        ...
        with col2:
            ...
            # st.markdown("[coursepage](http://localhost:8501/coursepage)")
            st.text("By : " + top12offeredby[1])
            st.text("Ratings : " + top12ratings[1])
            st.text("Duration : " + str(str(top12duration[1]) + " hr"))
            url1 = "http://localhost:8501/coursepage1"
            # login1 = st.button("coursepage",key="key1")
            #
            # if login1:
        ...
        with col3:
            ...
            st.text("By : " + top12offeredby[2])
            st.text("Ratings : " + top12ratings[2])
            st.text("Duration : " + str(str(top12duration[2]) + " hr"))
            url2 = "http://localhost:8501/coursepage2"
            # login2 = st.button("coursepage",key="key2")
            #
            # if login2:
        ...
        with ccol1:
            ...
            st.text("By : " + top12offeredby[3])
            st.text("Ratings : " + top12ratings[3])
            st.text("Duration : " + str(str(top12duration[3]) + " hr"))
            url3 = "http://localhost:8501/coursepage3"
            # login3 = st.button("coursepage",key="key3")
            #
            # if login3:
        ...
        with ccol2:
            ...
            st.text("By : " + top12offeredby[4])
            st.text("Ratings : " + top12ratings[4])
            st.text("Duration : " + str(str(top12duration[4]) + " hr"))
            url4 = "http://localhost:8501/coursepage3"
            # login4 = st.button("coursepage",key="key4")
            #
            # if login4:
        ...
        with ccol3:
            ...
            st.text("By : " + top12offeredby[5])
            st.text("Ratings : " + top12ratings[5])
            st.text("Duration : " + str(str(top12duration[5]) + " hr"))
            url5 = "http://localhost:8501/coursepage5"
            # login5 = st.button("coursepage",key="key5")
            #
            # if login5:
        ...
        with cccol1:
            ...
            st.text("By : " + top12offeredby[6])
            st.text("Ratings : " + top12ratings[6])
            st.text("Duration : " + str(str(top12duration[6]) + " hr"))
            url6 = "http://localhost:8501/coursepage6"
            # login6 = st.button("coursepage", key="key6")
            #
            # if login6:
        ...
        with cccol2:
            ...
            st.text("By : " + top12offeredby[7])
            st.text("Ratings : " + top12ratings[7])
            st.text("Duration : " + str(str(top12duration[7]) + " hr"))
            url7 = "http://localhost:8501/coursepage7"
            # login7 = st.button("coursepage", key="key7")
            #
            # if login7:
        ...
        with cccol3:
            ...
            st.text("By : " + top12offeredby[8])
            st.text("Ratings : " + top12ratings[8])
            st.text("Duration : " + str(str(top12duration[8]) + " hr"))
            url8 = "http://localhost:8501/coursepage8"
            # login8 = st.button("coursepage", key="key8")
            #
            # if login8:
        ...
        with cccol1:
            ...
            st.text("By : " + top12offeredby[9])
            st.text("Ratings : " + top12ratings[9])
            st.text("Duration : " + str(str(top12duration[9]) + " hr"))
            url9 = "http://localhost:8501/coursepage9"
            # login9 = st.button("coursepage", key="key9")
            #
            # if login9:
        ...
        with cccol2:
            ...
            st.text("By : " + top12offeredby[10])
            st.text("Ratings : " + top12ratings[10])
            st.text("Duration : " + str(str(top12duration[10]) + " hr"))
            url10 = "http://localhost:8501/coursepage10"
            # login10 = st.button("coursepage", key="key10")
            #
            # if login10:
        ...
        with cccol3:
            ...
            st.text("By : " + top12offeredby[11])
            st.text("Ratings : " + top12ratings[11])
            st.text("Duration : " + str(str(top12duration[11]) + " hr"))
            url11 = "http://localhost:8501/coursepage11"
            # login11 = st.button("coursepage", key="key11")
            #
            # if login11:
